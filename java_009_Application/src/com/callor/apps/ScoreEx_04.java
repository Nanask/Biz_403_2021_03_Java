 ...
 * 객체가 만들어진다 == 마치 변수처럼 기억장치 어딘가에 저장소가 만들어진다
...
public class ScoreEx_04 {
	...
	public static void main(String[] args) {
		...
		//.toString을 사용하면 정수를 문자열로 변환하여 사용할 수 있다.
		...
		//valueof()안에 들어있는 것을 자신과 같은 타입으로 변환시켜준다.
		...
		System.out.println(
				Integer.valueOf("30") 
				+ Integer.valueOf("40"));
		//변수를 사용하지 않고 mathod를 결합하여 사용하기도 하지만 자주 사용하는 것은 아니다.
