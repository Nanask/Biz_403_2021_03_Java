...
public class ScoreEx_01 {
	...
	public static void main(String[] args) {
		...
		int 이몽룡_Total = 이몽룡_kor + 이몽룡_eng + 이몽룡_math;

		
		// ScoreV0 클래스에 디자인된 코드를 보면 변수들이 있고 getTotal(), getAvg() method가 있다.
		// ScoreV0 클래스를 사용하여 만들어진 객체는 일부러 다른 데이터를 저장하지 않는 한 같은 사람의 데이터일 것이고
		// 과목점수만 잘 저장되어 있다면 언제든지 총점과 평균을 method를 통해서 얻어낼 수 있다.
