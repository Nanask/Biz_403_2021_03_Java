...
public class AddrEx_01 {
	 ...
	 * 팀프로젝트를 할때는 혼자 만드는 프로젝트가 아니다보니 이름들을 지울때 프로젝트 규칙을 따라야 한다.
	 * 
	 * 일부에서 한글로 변수명 등을 지으면 코드가 문제가 발생한다 라고 하지만 근거 없는 이야기이다.
	 * 
	...
	public static void main(String[] args) {
		...
		ssV1.printAddress("홍길동", "callor" , "010-0000-0000"); //문자열을 전달
		System.out.println("======================================");
		ssV1.printAddress(홍길동); //객체를 전달
