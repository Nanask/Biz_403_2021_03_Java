...
public class Varriable_01 {
	...
	public static void main(String[] args) {
		 ...
		 * 9. println() 은 덧셈결과가 보관된 기억장소를 찾아가서 보관 값을 가져와서
		 * 		System.out 에게 보낸다.
		 * 10. System.out 은 운영체제(윈도우)에게 결과를 Console(cmd 창)에 출력을 요청함
		 ...
		 * 기억장치 어딘가(임시)에 보관이 되어 연산 수행이 이루어진다.
		 * 
		 ...
		 * 
		 * 30과 40이라는 두 숫자를 어떤 지정된 기억장소에 보관해 두고 연산 시 그 값을 참조하여
		 * 연산을 하도록 한다면 기억장치를 효율적으로 사용할 수 있을 것이다.
		 * 
		 * 이러한 개념을 발전시킨 것을 "변수(Varriable)" 라고 한다.
		 * 
		 */
